public class Main {
	...
	public enum BusTicket {
		DAILY(1, 2.00, "Ticket valid for 24 hours"),
		WEEKLY(7, 13.30, "Ticket valid for 7 days"),
		MONTHLY(30, 54.00, "Ticket valid for 30 days"),
		QUARTERLY(90, 144.00, "Ticket valid for 3 month"),
		YEARLY(365, 474.50, "Ticket valid for 1 year");
